classdef Dynamic < matlab.mixin.Copyable
    ...
    methods
        ...
        function o=Dynamic(startDate,maturity,rebalancingInterval,initialWealth)
            ...
            o.histMarkToMarket=struct('initialWealthhhh',initialWealth);
            o.markToMarketHedgingPort=struct('initialWealthhhh',currentPort);
            o.vol=struct('initialWealthhhh',0);
            o.model=struct('initialWealthhhh',0);
...
%             o.dateString=vertcat('initialWealthhhh',o.dateString);
  ...
  %          model = dayData.blackScholesModel;
           ...
           % model.mu=0;
            ...
            model=dayData.varianceGammaModelHist;
...
%             assert(~arbitrage);    
            ...
            riskAversion = 2/o.initialWealth;
...
%               bid=ump.instruments{i}.getBid()
    ...
    totalInvestment
     ...
     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            o.model=setfield(o.model,date,model);
%            o.vol=setfield(o.vol,date,model.sigma);
            o.midFutures=setfield(o.midFutures,date,dayData.midFutures);
            [mark hedgingPort]=ump.markToMarket(port);
            o.histMarkToMarket=setfield(o.histMarkToMarket,date,-mark);
            o.markToMarketHedgingPort=setfield(o.histMarkToMarket,date,hedgingPort);
...
%     end
        ...
        function [adjustedMark adjustedSpot adjustedUtility ]=getMarkToMarket(o)
            try
                date=o.dateString;
