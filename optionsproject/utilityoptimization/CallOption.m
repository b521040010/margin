...
% commission is qouted in terms of percentage
    ...
    methods
        ...
        %these are marginal requirement for shorting 1 contract
        function marginal = marginal20(o,spot)
            marginal = (0.2*spot+min(spot-o.K,0))*o.contractSize+o.bid;
            %marginal = (0.2*spot+min(spot-o.K,0))*o.contractSize;
        end
        function marginal = marginal10(o,spot)
            marginal = (0.1*spot)*o.contractSize+o.bid;
            %marginal = (0.1*spot)*o.contractSize;
        end        
